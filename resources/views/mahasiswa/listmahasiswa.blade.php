                            ...
                            <div class="card card-info card-outline mb-4"><!--begin::Header-->
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex gap-2"> <!-- Kontainer baru untuk tombol -->
                                            <a class="btn btn-primary"  href="{{ route('iisma') }}">Tiket IISMA</a>
                                            <a class="btn btn-success"  href="{{ route('inspiba') }}">TIKET INSPIBA</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table id="table1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr class="align-middle">
                                                <th>NO</th>
                                                <th class="text-center" style="width: 30%">Nomor Induk Mahasiswa</th>
                                                <th class="text-center" style="width: 45%">Nama Mahasiswa</th>
                                            ...
                                            @foreach ($data as $index=>$list)
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @elseif ($list->status_user == 0)
                                                            <span class="badge text-bg-danger"> Tidak Aktif</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-left">
                                                        <div class="btn-group" role="group">
                                                            <a class="btn btn-success btn-sm" href="{{ route('lombamahasiswa', $list->id_userx)}}">Lomba Mahasiswa</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
