...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>IISMA | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                ...
                <br>
                    <div class="card card-info card-outline mb-4">
                        <div class="card-header">
                            <h5 class="mb-0">Pemesanan Tiket IISMA</h5>
                        </div>
                        <div class="card-body">
                            <form id="pesanTiketForm" method="POST" action="{{ route('iisma') }}">
                                @csrf
