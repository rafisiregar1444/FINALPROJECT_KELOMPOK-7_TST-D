...
<head>
    ...
    <title>Mahasiswa | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                            ...
                            <div class="card card-info card-outline mb-4"><!--begin::Header-->
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">Daftar Lomba Mahasiswa <span class="badge bg-success">{{ $user->nama_pt }}</span></h5>
                                        <a class="btn btn-success modal-trigger"  href="{{ route('pengajuanlombam', $user->id_userx) }}">Pengajuan</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table id="table1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr class="align-middle">
                                                <th>NO</th>
                                                <th class="text-center" style="width: 30%">Nama Lomba</th>
                                                <th class="text-center" style="width: 20%">Tanggal Menang</th>
                                        ...
                                        <tbody>
                                            @foreach ($data as $index=>$list)
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-left">{{ $list->lomba->nama_lomba }}</td>
                                                    <td class="text-center">{{ \Carbon\Carbon::parse($list->tanggal_menang)->translatedFormat('d F Y') }}</td>
                                                    ...
                                                    <td class="text-left">
                                                        <div class="btn-group" role="group">
                                                            <a class="btn btn-primary btn-sm modal-trigger" href="{{ route('editpengajuanlombam', $list->id_lomba_mahasiswa)}}">Edit</a>
                                                            <a class="btn btn-danger btn-sm" href="{{ route('deletepengajuanlombam', $list->id_lomba_mahasiswa)}}">Hapus</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('listmahasiswa') }}">Kembali</a>
                                </div><!-- /.card-body -->
                            </div>          
                </div>
            </div>
