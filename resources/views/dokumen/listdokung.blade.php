...
<head>
    ...
    <title>Dokumen Pendukung | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                            ...
                            <div class="card mb-6">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0">List Dokumen Pendukung</h5>
                                        <a class="btn btn-success modal-trigger"  href="{{ route('adddokumen') }}">Dokumen Baru</a>
                                    </div><!--end::Row-->
                                </div>
                                ...
                                <table id="table1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr class="align-middle">
                                            ...
                                            <th class="text-center" style="width: 25%">Syarat Dokumen</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $index=>$list)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-left">{{ $list->jenis_dok }}</td>
                                                <td class="text-left">{{ $list->nama_dok }}</td>
                                                <td class="text-center">
                                                    @if ($list->digunakan == '1')
                                                        <strong style="color: black;">Pengajuan Kuota</strong>
                                                    @elseif ($list->digunakan == '2')
                                                        <strong style="color: black;">Pencarian</strong>
                                                    @elseif ($list->digunakan == '3')
                                                        <strong style="color: black;">Pertanggungjawaban</strong>
                                                    @else
                                                    ...
                                                    <div class="btn-group mb-2" role="group"
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item modal-trigger" href="{{ route('editdokumen', $list->id_dok)}}">Edit</a></li>
                                                                <li><a class="dropdown-item delete-confirm" href="{{ route('deletedokumen', $list->id_dok)}}" id="delete">Hapus</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col text-left">
                                                    <button type="button" class="btn btn-secondary" onclick="cancelDelete()">Batal</button>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
