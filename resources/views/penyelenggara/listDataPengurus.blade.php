...
<head>
    ...
    <title>Data Pengurus | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group mb-2" role="group" aria-label="Button group with nested dropdown">
                                                        ...
                                                        <a class="btn btn-secondary mr-2" onClick="add()" href="{{ $list->id_akta_yys ? route('aktakumham', ['id_akta_yys' => $list->id_akta_yys]) : '#' }}">Data Akta KUMHAM</a>
                                                        <a class="btn btn-danger ml-auto delete-confirm" onClick="add()" href="{{ $list->id_pengurus ? route('deleteajukankumham', $list->id_pengurus) : '#' }}" id="delete">Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
