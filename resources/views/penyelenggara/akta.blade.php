...
<head>
    ...
    <title>Akta Yayasan | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                ...
                <div class="container-fluid"><!--begin::Row-->
                    <div class="card card-info card-outline mb-4"><!--begin::Header-->
                        <div class="card-header">
                            <h5 class="mb-0">Buat Data Akta</h5>
                        </div>
                        <div class="card-header">
                            <h3 class="mb-0" style="color: green;">{{ $yayasanData->nama_yys_pt }}</h3>
                        </div>
                        <form action="{{ route('storeakta', ['id_yys_pt' => $yayasanData->id_yys_pt]) }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="nomor_akta" class="form-label">No Akta</label>
                                        <input type="text" name="nomor_akta" class="form-control" id="nomor_akta" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="tanggal_akta" class="form-control" id="tanggal_akta" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nama_notaris" class="form-control" id="nama_notaris" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="kota_notaris" class="form-control" id="kota_notaris" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="kode_akta" id="kode_akta" required>
                                            ...
                                            <option value="1">Pendirian Baru</option>
                                            <option value="2">Perubahan</option>
                                            <option value="3">Pembubaran</option>
                                        </select>
                                        <div class="invalid-feedback">
                        ...
                        <div class="card-body">
                            <div class="card mb-6">
                                ...
                                <div class="card-header">
                                    <h5 class="text-center" style=>Data Notaris</h5>
                                </div>
                                    <thead>
                                    ...
                                    <tbody>
                                    @if($aktaData)
                                        @foreach ($aktaData as $index => $list) 
                                        <tr class="align-middle">
                                                ...
                                                <div class="btn-group mb-2" role="group" aria-label="Button group with nested dropdown">
                                                    <div class="btn-group" role="group"><button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item delete-confirm" href="{{ route('deleteakta', $list->id_akta_yys)}}" id="delete">Hapus</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
