...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"><!--begin::App Wrapper-->
    <div class="app-wrapper"><!--begin::Header-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"><!--begin::Sidebar Brand-->
            <div class="sidebar-brand"><!--begin::Brand Link--><a href="/dashboard"
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview active">
                                <li class="nav-item"><a href="/listbp" class="nav-link active"><i
                                                    ...
                                                    <div class="btn-group mb-2" role="group"
                                                        ...
                                                        <div class="btn-group" role="group"><button type="button"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="/editbp">Edit
                                                                        BP</a></li>
                                                                <li><a class="dropdown-item" href="/aktabp">Akta
                                                                        BP</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="/deletebp">Hapus</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        <footer class="app-footer"><!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">TEXT HERE</div><!--end::To the end-->
            <!--begin::Copyright-->
            <strong>
                Copyright &copy; 2023&nbsp;
