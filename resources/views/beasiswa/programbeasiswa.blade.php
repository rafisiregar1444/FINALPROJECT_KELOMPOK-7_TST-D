...
<head>
    ...
    <title>Program Beasiswa | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                            ...
                            <div class="card mb-6">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0">Program Beasiswa</h5>
                                        <a class="btn btn-success modal-trigger"  href="{{ route('addbeasiswa') }}">Jenis Baru</a>
                                    </div><!--end::Row-->
                                </div>
                                ...
                                <table id="table1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr class="align-middle">
                                            <th>NO</th>
                                            <th class="text-center" style="width: 25%">Nama Beasiswa</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $index=>$list)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-left">{{ $list->jenis_beasiswa }}</td>
                                                <td class="text-center">
                                                    @if ($list->pt_penerima == '1')
                                                        <strong style="color: black;">UM</strong>
                                                    @elseif ($list->pt_penerima == '0')
                                                        <span style="color: black;">Reguler</span>
                                                    @else
                                                    ...
                                                    <div class="btn-group mb-2" role="group"
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item " href="{{ route('editbeasiswa', $list->id_beasiswa)}}">Edit</a></li>
                                                                @if($list->pt_penerima == 1)
                                                                    <li><a class="dropdown-item" href="{{ route('komponenbeasiswa', $list->id_beasiswa)}}">Komponen</a></li>
                                                                @endif
                                                                <li><a class="dropdown-item delete-confirm" href="{{ route('deletebeasiswa', $list->id_beasiswa)}}" id="delete">Hapus</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
