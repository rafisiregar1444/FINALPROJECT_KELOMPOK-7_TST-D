...
<head>
    ...
    <title>Lomba | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                            ...
                            <div class="card mb-6">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0">List Lomba</h5>
                                        <a class="btn btn-success modal-trigger"  href="{{ route('addlomba') }}">Dokumen Baru</a>
                                    </div><!--end::Row-->
                                </div>
                                ...
                                <table id="table1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr class="align-middle">
                                            <th>NO</th>
                                            <th class="text-center" style="width: 25%">Nama Lomba</th>
                                            <th class="text-center" style="width: 25%">Keterangan</th>
                                            <th class="text-center" style="width: 25%">Jenis Lomba</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $index=>$list)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">{{ $list->nama_lomba}}</td>
                                                <td class="text-left">{{ $list->keterangan}}</td>
                                                <td class="text-center">
                                                    @if ($list->jenis_lomba == '1')
                                                        <strong class="text-primary">Nasional</strong>
                                                    @elseif ($list->jenis_lomba == '2')
                                                        <strong class="text-success">Internasional</strong>
                                                    @elseif ($list->jenis_lomba == '3')
                                                        <strong class="text-warning">Regional</strong>
                                                    @else
                                                    ...
                                                    <div class="btn-group mb-2" role="group"
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item modal-trigger" href="{{ route('editlomba', $list->id_lomba)}}">Edit</a></li>
                                                                <li><a class="dropdown-item delete-confirm" href="{{ route('deletelomba', $list->id_lomba)}}" id="delete">Hapus</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
