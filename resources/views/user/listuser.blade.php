...
<head>
    ...
    <title>Daftar User | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                            ...
                            <div class="card mb-6">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0">Daftar User <strong>LLDIKTI Wilayah VII</strong></h5>
                                        <div>
                                            <a class="btn btn-primary"  href="{{ route('addusermahasiswa') }}">User Baru Mahasiswa</a>
                                            <a class="btn btn-success"  href="{{ route('adduser') }}">User Baru</a>
                                        </div>
                                    </div><!--end::Row-->
                                </div>
                                <div class="card-body">
                                <table id="table1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr class="align-middle">
                                            ...
                                            <th class="text-center" style="width: 35%">Nama PT</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $index=>$list)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-left">{{ $list->nama_pt }}</td>
                                                <td class="text-center">
                                                    @if ($list->role == 'admin')
                                                        <span class="badge text-bg-primary">Admin</span>
                                                    @elseif ($list->role == 'user')
                                                        <span class="badge text-bg-secondary">User</span>
                                                    @elseif ($list->role == 'mahasiswa')
                                                        <span class="badge text-bg-warning">Mahasiswa</span>
                                                    @else
                                                        <span class=""><strong>Belum Terdaftar</strong></span>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                                    ...
                                                    <div class="btn-group mb-2" role="group"
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="{{ route('edituser', $list->id_userx)}}">Edit</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('resetuserpass', $list->id_userx)}}">Reset Passowrd</a></li>
                                                                <li><a class="dropdown-item delete-confirm" href="{{ route('deleteuser', $list->id_userx)}}" id="delete">Hapus</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
