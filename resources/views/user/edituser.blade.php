...
<head>
    ...
    <title>Edit User | LLDIKTI Wilayah VII</title><!--begin::Primary Meta Tags-->
    ...
    <div class="app-wrapper"><!--begin::Header-->
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">
                                    ...
                                    @if($data->role == 'mahasiswa')
                                    @else
                                        <a class="btn btn-success modal-trigger role" href="{{ route('roleedit', ['id_userx' => $data->id_userx]) }}">Perubahan Role</a>
                                    @endif                            
                            </div>
                        </div>
                        <div class="card-header">
                            <h3 class="mb-0" style="color: green;">
                                @if($data->role == 'mahasiswa')
                                    {{ $data->username }} <!-- Menampilkan username jika role adalah mahasiswa -->
                                @else
                                    {{ $data->nama_pt }} <!-- Menampilkan nama_pt untuk role lain -->
                                @endif
                            </h3>                        
                        </div>
                        <form action="{{ route('updateuser', ['id_userx' => $data->id_userx]) }}" method="POST">
                        @csrf
                        @method('put')
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="kode_pt" class="form-control" id="kode_pt" value="{{ $data->kode_pt }}" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nama_pt" class="form-control" id="nama_pt" value="{{ $data->nama_pt }}">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-12">
                                        <label for="role" class="form-label">Role [<span style="color: red; font-weight: bold;">Khusus admin LLDIKTI kosongkan</span>]</label>
        ...
        <script>
            ...
            Swal.fire({
                ...
                text: 'Anda akan mengubah role {{ $data->nama_pt }}',
                icon: 'question',
