...
<head>
    ...
    <title>Reset Password User | LLDIKTI Wilayah VII</title><!--begin::Primary Meta Tags-->
            ...
            <div class="app-content"><!--begin::Container-->
                ...
                <br>
                    <div class="card card-info card-outline mb-4"><!--begin::Header-->
                        ...
                        <div class="card-header">
                            <h3 class="mb-0" style="color: green;">{{ $data->nama_pt }}</h3>
                        </div>
                        <form action="{{ route('resetuserpassupdate', ['id_userx' => $data->id_userx]) }}" method="POST">
                        @csrf
                        @method('put')
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nama_pt" class="form-control" id="nama_pt" value="{{ $data->nama_pt }}"disabled>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="status_user" id="status_user" disabled>
