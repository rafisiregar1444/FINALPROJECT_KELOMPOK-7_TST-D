...
<head>
    ...
    <title>User Baru | LLDIKTI Wilayah VII</title><!--begin::Primary Meta Tags-->
                    ...
                    <div class="card card-info card-outline mb-4"><!--begin::Header-->
                        ...
                        <form action="{{ route('storeuser') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="kode_pt" class="form-label">Khusus Kode Perguruan Tinggi [<span style="color: red; font-weight: bold;">bila admin LLDIKTI kosongkan</span>]</label>
                                        <input type="text" name="kode_pt" class="form-control" id="kode_pt" required>
                                        <div class="invalid-feedback">
                                            Harap masukkan Kode PT.
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="nama_pt" class="form-label">Khusus Nama Perguruan Tinggi [<span style="color: red; font-weight: bold;">bila admin LLDIKTI kosongkan</span>]</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="username" class="form-label">Gunakan Kode Perguruan Tinggi -- Nama User Admin LLDIKTI [<span style="color: red; font-weight: bold;">Maks. 15 Char</span>]</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="type" id="type" required>
                                            ...
                                            <option value="5">Pejabat Struktural</option>
                                            <option value="1">Admin LLDIKTI</option>
                                            <option value="3">Operator LLDIKTI</option>
                                            <option value="2">Admin Perguruan Tinggi</option>
                                        </select>
                                        <div class="invalid-feedback">
                                            Harap pilih Jenis .
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <label for="role" class="form-label">Role [<span style="color: red; font-weight: bold;">Khusus Admin LLDIKTI</span>]</label>
