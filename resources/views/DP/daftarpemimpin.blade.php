...
<head>
    ...
    <title>Daftar Pemimpin | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                            ...
                            <div class="card mb-6">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0">Daftar Pemimpin Perguruan Tinggi</h5>
                                    </div><!--end::Row-->
                                </div>
                                ...
                                <table id="table1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr class="align-middle">
                                            ...
                                            <th class="text-center" style="width: 40%">Nama PT</th>
                                        ...
                                        @if ($list->id_pts !== null)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    @if ($list->nama_pimpinan !== null)
                                                        {{ $list->nama_pimpinan }}
                                                    @else
                                                        <strong class="badge text-bg-secondary">Belum Ada</strong>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                                    @if ($list->nm_jabatan_pim !== null)
                                                        {{ $list->nm_jabatan_pim }}
                                                    @else
                                                        <strong class="badge text-bg-secondary">Belum Ada</strong>
                                                    @endif
                                                ...
                                                <td class="text-center">
                                                  <a class="btn btn-primary" href="{{ route('daftarpejabat', $list->id_pts) }}">Daftar Pejabat</a>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
