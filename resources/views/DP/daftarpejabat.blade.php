...
<head>
    ...
    <title>Daftar Pejabat | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"><!--begin::App Wrapper-->
                            ...
                            <div class="card card-info card-outline mb-4"><!--begin::Header-->
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="btn btn-success modal-trigger" data-modal-id="modal-default" href="{{ route('newdaftarpejabat', ['id_pts' => $dataPT->id_pts]) }}">Rekam Baru</a>
                                    </div><!--end::Row-->
                                </div>
                                <div class="card-header">
                                    <h3 class="mb-0" style="color: green;">{{ $dataPT->nama_pts }}</h3>
                                </div>
                                ...
                                <table id="table1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr class="align-middle">
                                            ...
                                            <th class="text-center" style="width: 15%">Nomor HP</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $index => $list)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">{{$list->nama_pimpinan}}</td>
                                                <td class="text-center">{{$list->jabatan->nm_jabatan_pim ?? 'N/A'}}</td>
                                                <td class="text-center">{{$list->no_hp}}</td>
                                                <td class="text-center">{{$list->formatted_tgl_awal}} - {{$list->formatted_tgl_akhir}}</td>
                                                <td class="text-center">
                                                    @if($list->status_jab == 1)
                                                ...
                                                <div class="btn-group mb-2" role="group" aria-label="Button group with nested dropdown">
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="dropdown-item modal-trigger" data-modal-id="modal-update" href="{{ route('editdaftarpejabat', ['id_pimpinan' => $list->id_pimpinan]) }}">Edit PT</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item delete-confirm" href="{{ route('deletedaftarpejabat', ['id_pimpinan' => $list->id_pimpinan]) }}">Hapus</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                ...
                                <a class="btn btn-secondary" href="{{ route('daftarpemimpin') }}">Kembali</a>
                            </div><!-- /.card-body -->
                            <br>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.buatbaru').click(function(e) {
                e.preventDefault();
                let url = $(this).attr('href');

                Swal.fire({
                    title: 'Tidak bisa melakukan perubahan!',
                    text: 'Anda harus merekam data baru',
                    icon: 'warning',
