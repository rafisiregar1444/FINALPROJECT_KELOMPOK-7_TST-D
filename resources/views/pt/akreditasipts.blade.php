...
<head>
    ...
    <title>Akreditasi Perguruan Tinggi| LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                    ...
                    <div class="card card-info card-outline mb-4"><!--begin::Header-->
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Akreditasi Perguruan Tinggi</h5>
                                <a class="btn btn-success modal-trigger" data-modal-id="modal-default" href="{{ route('akreditasiptnew', ['id_pts' => $pt->id_pts]) }}">Rekam Baru</a>
                            </div>
                        </div>
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nm_peringkat" class="form-control" id="nm_peringkat" value="{{ $box->peringkat->nm_peringkat ?? 'Belum Terdaftar' }}" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="no_sk_apt" class="form-control" id="no_sk_apt" value="{{ $box->no_sk_apt ?? 'Belum Terdaftar' }}" disabled>
                                        <div class="invalid-feedback">
                                            Harap masukkan No SK APT.
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="nama_notaris" class="form-label">Masa Berlaku</label>
                                        <input type="date" name="tgl_akhir_apt" class="form-control" id="tgl_akhir_apt" value="{{ $box->tgl_akhir_apt ?? 'Belum Terdaftar' }}" disabled>
                                        <div class="invalid-feedback">
                                            Harap masukkan Tanggal Akhir APT.
                                        </div>
                                    </div>
                                </div>
                                <br>
                        ...
                        <div class="card-body">
                            <div class="card mb-6">
                                ...
                                <div class="card-header">
                                    <h5 class="text-center" style=>Data Akreditasi</h5>
                                </div>
                                    <thead>
                                    ...
                                    @if($data)
                                        ...
                                        <td class="text-center">{{ $list->lembagaakreditasi->sort_lembaga ?? 'Belum Terdaftar' }}</td>
                                        <td class="text-center">{{ $list->no_sk_apt ?? 'Belum Terdaftar' }}<br>{{ \Carbon\Carbon::parse($list->tgl_sk_apt)->translatedFormat('j F Y') }}</td>
                                        <td class="text-center">{{ \Carbon\Carbon::parse($list->tgl_akhir_apt)->translatedFormat('j F Y') }}</td>
                                            <td class="text-center">
                                                    @if($list)
                                                        <div>
                                                            @switch($list->peringkat->nm_peringkat ?? 'Belum Terdaftar')
                                                                @case('A')
                                                ...
                                                <div class="btn-group mb-2" role="group" aria-label="Button group with nested dropdown">
                                                    <div class="btn-group" role="group"><button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item modal-trigger" href="{{ route('akreditasiptedit', $list->id_akreditasi) }}">Edit</a></li>
                                                            @if ($list->status_akreditasi !== null)
                                                                <li><a class="dropdown-item delete-confirm" href="{{ route('deleteakreditasi', $list->id_akreditasi) }}" id="delete">Hapus</a></li>
                                                            @endif
                                                        </ul>
                                                    </div>
                                                </div>
