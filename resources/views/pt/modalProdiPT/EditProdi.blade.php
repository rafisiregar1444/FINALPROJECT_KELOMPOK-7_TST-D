<form action="{{ route('prodiptupdate', $data->id_prodi_pts) }}" method="POST" enctype="multipart/form-data">
 @csrf
 @method('PUT')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">'
                <div class="modal-header">
                    <h4 class="modal-title">Perbarui Program Studi <span class="badge bg-success">{{ $pt->nama_pts }}</h4>
                            ...
                            <div class="modal-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="kode_prodi" class="form-control" id="kode_prodi" value="{{ $data->kode_prodi }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nama_prodi" class="form-control" id="nama_prodi" value="{{ $data->nama_prodi }}" required>
                                        <div class="invalid-feedback">
                                ...
                                @endif
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="no_sk" class="form-control" id="no_sk" value="{{ $data->no_sk }}"required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="tgl_sk" class="form-control" id="tgl_sk" value="{{ $data->tgl_sk }}"required>
                                        <div class="invalid-feedback">
