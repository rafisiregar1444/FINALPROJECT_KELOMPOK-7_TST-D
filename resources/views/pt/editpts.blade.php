...
<head>
    ...
    <title>Perbarui Perguruan Tinggi | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"><!--begin::App Wrapper-->
                            ...
                            <div class="card card-info card-outline mb-4"><!--begin::Header-->
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">Perbarui Perguruan Tinggi</h5>
                                        <a class="btn btn-success modal-trigger status" href="{{ route('perubahanstatus', ['id_pts' => $data->id_pts]) }}">Perubahan Status</a>
                                    </div>
                                </div>
                                <div class="card-header">
                                    <h3 class="mb-0" style="color: green;">{{ $data->nama_pts }}</h3>
                                </div>
                                    <form action="{{ route('updatepts', $data->id_pts) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                                    <div class="card-body">
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                <label for="validationCustom01" class="form-label">Kode PT</label>
                                                                <input type="text" class="form-control" id="validationCustom01" value="{{ $data->kd_pts }}" name="kd_pts">
                                                                <div class="invalid-feedback">
                                                                    Masukkan Kode PT
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="validationCustom01" class="form-label">Nama PT</label>
                                                                <input type="text" class="form-control" id="validationCustom01" value="{{ $data->nama_pts }}" name="nama_pts">
                                                                <div class="invalid-feedback">
                                                                    Masukkan Nama PT
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <select class="form-select" id="validationCustom04" name="status_pts" disabled>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" value="{{ $data->alamat }}" name="alamat">
                                                                <div class="invalid-feedback">
                                                                    Masukkan Alamat PT
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" value="{{ $data->no_telp }}" name="no_telp">
                                                                <div class="invalid-feedback">
                                                                    Masukkan Alamat PT
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" value="{{ $data->email }}" name="email">
                                                                <div class="invalid-feedback">
                                                                    Masukkan Email PT
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="validationCustom01" class="form-label">Laman</label>
                                                                <input type="text" class="form-control" id="validationCustom01" value="{{ $data->laman }}" name="laman">
                                                                <div class="invalid-feedback">
                                                                    Masukkan Laman PT
                                                                </div>
                                                            </div>
                                                            @if (isset($data->kota) && $data->kota)
                                                                <div class="col-md-6">
                                                                    <label for="validationCustom04" class="form-label">Nama Kota</label>
                                                                    <select class="form-select" id="validationCustom04" name="nm_kota">
                                                                        <option selected disabled value="">--Pilih--</option>
                                                                        @foreach($allKota as $item)
                                                                            <option value="{{ $item->id_kota }}" 
                                                                                {{ $data->kota->id_kota === $item->id_kota ? 'selected' : '' }}>
                                                                                {{ $item->nama_kota }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="date" class="form-control" id="ultah" name="ultah" value="{{ $data->ultah }}"required>
                                                                <div class="invalid-feedback">
    ...
    <script>
        ...
        $('.status').click(function(e) {
            ...
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: 'Anda akan mengubah status {{ $data->nama_pts }}',
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
