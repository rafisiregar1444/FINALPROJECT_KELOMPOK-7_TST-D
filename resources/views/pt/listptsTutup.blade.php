...
<head>
    ...
    <title>List Perguruan Tinggi Tutup | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-outline card-danger">
                                ...
                                <div class="card-header">
                                    <h5 class="text-center" >Data Perguruan Tinggi Tidak Beroperasional</h5>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $index=>$list)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-left">{{ $list->kd_pts }}</td>
                                                ...
                                                <td class="text-center">
                                                    @if($list)
                                                        ...
                                                        <div>
                                                            @switch($list->ket)
                                                                @case('success')
                                                                    <span class="badge text-bg-success">Sukses Terakreditasi</span>
                                                                    @break
                                                                @case('secondary')
                                                                    <span class="badge text-bg-warning">Belum Akreditasi</span>
                                                                    @break
                                                                @default
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group mb-2" role="group">
                                                        <a class="btn btn-warning" href="{{ route('ajukanakreditasi')}}">Ajukan Akreditasi</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
