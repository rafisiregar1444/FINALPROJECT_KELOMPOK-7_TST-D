<form action="{{ route('akreditasipsstore', ['id_prodi_pts' => $ps->id_prodi_pts]) }}" method="POST" enctype="multipart/form-data">
 @csrf
                            ...
                            <div class="modal-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="id_lembaga_aps" name="id_lembaga_aps" required>
                                            ...
                                            @foreach($alllembaga as $item)
                                                <option value="{{ $item->id_lembaga_aps }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="no_sk_aps" class="form-control" id="no_sk_aps" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="tgl_sk_aps" class="form-control" id="tgl_sk_aps" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="tgl_akhir_aps" class="form-control" id="tgl_akhir_aps" required>
                                        <div class="invalid-feedback">
