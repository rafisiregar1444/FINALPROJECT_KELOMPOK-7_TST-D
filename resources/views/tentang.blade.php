...
<head>
    ...
    <title>Tentang Sistem | LLDIKTI Wilayah</title><!--begin::Primary Meta Tags-->
                        ...
                        <div class="card card-info card-outline mb-4"><!--begin::Header-->
                            ...
                            <form action="/uploadImage" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label for="name" class="control-label" style="font-weight: bold;">Nama Sistem</label>
                                            <input type="text"  class="form-control form-control-sm" name="name_app" id="name_app" value="Nama Sistem">
                                        </div>     
                                        <div class="col-md-12">
                                            <label for="pengembang" class="control-label" style="font-weight: bold;">Pengembang</label>
                                            <input type="text" class="form-control form-control-sm" name="pengembang" id="pengembang"  value="">
                                        </div>
                                        <div class="col-md-12">
                                            <label for="" class="control-label" name="image" style="font-weight: bold;">Logo [<span style="color: red; font-weight: bold;">Hapus Terlebih Dahulu Jika Sudah Ada Logo</span>] <a href="{{ route('deleteimage') }}" class="btn btn-danger">Hapus</a></label>
                                            ...
                                            <div class="form-group d-flex justify-content-center">
                                                <img src="{{ URL('uploadLogo/Logo') }}?t=<?php echo time(); ?>" alt="" id="cimg" class="img-fluid img-thumbnail" style="max-width: 200px;">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
